...
mutation createCard($token:ID!, $owned:Boolean!, $cardName:String!, $displayName:String, $name:String!,
...
mutation updateCard($token:ID!, $id: ID!, $cardName: String, $displayName:String, $name:String,
